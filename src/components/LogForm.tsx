...
export default function LogForm({ onSubmit }: { onSubmit: (data: any) => void }) {
  const { plan, noSpendDayLogged, spendLoggedToday } = useTracking();
  const [step, setStep] = useState<1 | 2 | 3>(1); // 1: Amount, 2: Category, 3: Success/Reflect
        ...
        {step === 1 && (
          ...
          >
            <div className="space-y-2">
              ...
              <h2 className="text-3xl font-serif">{isSavingsMode ? "How much did you save?" : "How much did you spend?"}</h2>
            </div>
            ...
            <div className="relative group">
              ...
              <input 
                ...
                className="w-full bg-transparent border-b-2 border-primary/10 focus:border-primary px-10 py-6 text-5xl font-serif outline-none transition-all"
              />
            </div>
