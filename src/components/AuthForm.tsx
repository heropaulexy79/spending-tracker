    ...
    <div className="w-full max-w-md mx-auto p-8 glass-card animate-in relative overflow-hidden">
      ...
      <div className="mt-8 pt-6 border-t border-border/50 text-center flex flex-col items-center gap-2">
        <div className="flex items-center gap-1.5 text-emerald-500 font-bold text-[10px] uppercase tracking-wider">
          ...
          Privacy & Trust Guaranteed
        </div>
        <p className="text-[10px] text-muted-foreground leading-relaxed max-w-[280px]">
          Your personal logs, reflections, and insights are stored securely and remain 100% private to you. We never sell or share your data.
        </p>
      </div>
    </div>
  );
