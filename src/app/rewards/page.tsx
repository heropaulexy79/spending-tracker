...
const REWARD_ITEMS = [
  {
    id: "behavioral_breakdown",
    title: "Monthly Behavioral Breakdown",
    description: "100 coins = Deep patterns identified by our archetypal engine.",
    cost: 100,
  ...
  },
  {
    ...
    title: "7-Day Impulse Control",
    description: "Unlock a personalized challenge to master your spending triggers.",
    cost: 200,
  ...
  {
    id: "ai_triggers",
    title: "AI Trigger Discovery",
    description: "What's my biggest spending trigger? Use 300 coins to find out.",
    cost: 300,
  ...
  },
  {
    ...
    description: "Unlock premium resources and templates for conscious spending.",
    cost: 75,
    icon: <Target className="w-6 h-6" />,
    color: "text-rose-500",
  ...
  },
  {
    ...
    description: "Access partner discounts and exclusive financial courses.",
    cost: 150,
